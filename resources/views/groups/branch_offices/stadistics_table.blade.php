    ...
    <div class="card-header">
        ...
        <div class="download">
            <form class="download-form" action="download" method="post">
                ...
                <input name="report-name" type="hidden" value="Reporte estadístico de sucursales">
        ...
        <div class="table-responsive">
            @if($stadistics_data)
                <table class="table table-bordered data-table table-striped table-sm" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            @php($headers = array_keys((Array)$stadistics_data[0]))
                    ...
                    <tbody>
                        @foreach($stadistics_data as $data)
                            <tr class="tr">
